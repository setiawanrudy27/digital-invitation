...
import { Geist, Geist_Mono, Playfair_Display, Italianno, Quicksand, Parisienne } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="id"
      className={`${geistSans.variable} ${geistMono.variable} ${playfair.variable} ${italianno.variable} ${quicksand.variable} ${parisienne.variable}`}
    >
